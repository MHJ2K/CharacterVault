...
export function createDefaultDraft(): SettingsDraft {
  return {
    ...
    agentStagedEdits: DEFAULT_AGENT_STAGED_EDITS,
    ...
    const loadSettings = async () => {
      ...
      try {
        ...
        setDraft({
          ...
          agentStagedEdits: fullSettings.ui?.agentStagedEdits ?? DEFAULT_AGENT_STAGED_EDITS,
    ...
    try {
      ...
      await characterSettingsService.saveSettings({
        ...
        ui: {
          ...
          agentStagedEdits: draft.agentStagedEdits,
        },
